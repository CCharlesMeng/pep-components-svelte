<script lang="ts">
    ...
    let { mainContent, backgroundImage, onDeploy, onOpenExternal }: Props = $props();
    ...
    <div class="pep-cloud-deploy-flow-main__container">
        ...
        <section class="pep-cloud-deploy-flow-main__block">
            ...
            <div class="pep-cloud-deploy-flow-main__estimate-line">
                ...
                <p class="pep-cloud-deploy-flow-main__estimate-note">{mainContent.deploymentEstimate.priceNote}</p>
            </div>
        ...
        <section class="pep-cloud-deploy-flow-main__block">
            <button type="button" disabled={!isAgreementChecked} onclick={handleDeployClick}>
